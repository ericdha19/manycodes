...
namespace Twin2Twin
{
    ...
    public partial class Elevator
    {
        public static Elevator FromJson(string json) => JsonConvert.DeserializeObject<Elevator>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Elevator self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
